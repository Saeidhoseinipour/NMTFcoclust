...
- $OPNMTF_{\alpha}$ 
 $$D_{\alpha}(\mathbf{X}||\mathbf{FSG}^{T})+ 
      \lambda D_{\alpha}(\mathbf{I}_{g}||\mathbf{F}^{T}\mathbf{F})+\mu D_{\alpha}(\mathbf{I}_{g}||\mathbf{F}^{T}\mathbf{F})$$  
- $ONMTF_{\alpha}$
   $$D_{\alpha}(\amthbf{X}||\mathbf{FSG}^{T})+ \delta Tr(\mathbf{F}\Psi_{g}\mathbf{F}^{T}) +	\beta Tr(\mathbf{G} \Psi_{s}\mathbf{G}^{T})$$
- $NMTF_{\alpha}$
 $$D_{\alpha}(\mathbf{X}||\mathbf{FSG}^{T})$$ 
- $NBVD$
